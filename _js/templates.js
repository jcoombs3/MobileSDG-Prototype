...
var blocksData = {
    ...
    imgSlider: "<div class='block img-slider' style='background:{{bgColor}}'><div class='slider-container'><ul>{{#each imgs}}<li><img src='_img/apps-images/{{folder}}/{{img}}'></li>{{/each}}<div class='clearfix'></div></ul><div class='arrow arrow-left'><img src='_img/slider-arrow-left.png'></div><div class='arrow arrow-right'><img src='_img/slider-arrow-right.png'></div></div></div>",
