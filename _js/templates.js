...
var blocksData = {
    ...
    imgSlider: "<div class='block img-slider' style='background:{{bgColor}}'><div class='slider-container'><ul>{{#each imgs}}<li><table><tr><td><img src='_img/apps-images/{{folder}}/{{img}}'></td></tr></table></li>{{/each}}<div class='clearfix'></div></ul><div class='arrow arrow-left'></div><div class='arrow arrow-right'></div></div></div>",
